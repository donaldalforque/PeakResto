...
Begin VB.Form PO_SalesReturnTagFrm 
   BackColor       =   &H00FFFFFF&
   ...
   End
End
Attribute VB_Name = "PO_SalesReturnTagFrm"
...
Private Sub Form_Load()
    ...
    lvModules.ColumnHeaders(5).width = lvModules.width * 0
        ...
        Do Until rec.EOF
            If rec!isCashAdvance = "False" Then
                    Set item = lvModules.ListItems.add(, , rec!SalesReturnId)
                        ...
                        If rec!PurchaseReturnId <> PO_PurchaseReturnFrm.PurchaseReturnId Then
                            item.Checked = False
                        Else
                            item.Checked = True
...
Private Sub lvModules_DblClick()
    If lvModules.ListItems.Count > 0 Then
        If PO_PurchaseReturnFrm.Visible = True Then Exit Sub
