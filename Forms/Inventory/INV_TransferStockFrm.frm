...
Begin VB.Form INV_TransferStockFrm 
   ...
   Begin VB.PictureBox picCompleted 
      ...
      Height          =   2295
      Left            =   -9999
      Picture         =   "INV_TransferStockFrm.frx":10C9C
      ScaleHeight     =   2295
      ScaleWidth      =   6195
      TabIndex        =   23
      Top             =   2640
   ...
   Begin VB.Frame Body_Frame1 
      ...
      Begin VB.Frame Frame_Body 
         ...
         Begin VB.CheckBox chkConvert 
            BackColor       =   &H00FFFFFF&
            Caption         =   "Convert wholesale items to retail on transfer"
            BeginProperty Font 
               Name            =   "Calibri"
               Size            =   9.75
               Charset         =   0
         ...
         Begin VB.CommandButton btnItemSearch 
            Height          =   330
            Left            =   4800
            Picture         =   "INV_TransferStockFrm.frx":1932A
            Style           =   1  'Graphical
            TabIndex        =   14
            Top             =   240
            Width           =   375
   ...
   Begin VB.PictureBox picPaid 
      ...
      Height          =   1860
      Left            =   -9960
      Picture         =   "INV_TransferStockFrm.frx":1954E
      ScaleHeight     =   1860
      ScaleWidth      =   5250
      TabIndex        =   0
      Top             =   2640
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INV_TransferStockFrm.frx":224DF
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INV_TransferStockFrm.frx":28D41
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INV_TransferStockFrm.frx":2F5A3
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INV_TransferStockFrm.frx":35E05
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INV_TransferStockFrm.frx":3607A
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INV_TransferStockFrm.frx":366EB
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "INV_TransferStockFrm"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Public StatusId, WarehouseManagerId, TransferStockId, id As Integer
...
Private Sub Save(ByVal StatusId As Integer, Optional isReopen As Variant)
    If Validated = True Then
        ...
        Dim isConvert As Boolean
        If chkConvert.value = vbChecked Then isConvert = True
        ...
        cmd.Parameters.Append cmd.CreateParameter("@TransferStockId", adInteger, adParamInputOutput, , TransferStockId)
        ...
        cmd.Parameters.Append cmd.CreateParameter("@WarehouseManagerId", adInteger, adParamInput, , WarehouseManagerId)
        ...
        cmd.Parameters.Append cmd.CreateParameter("@WarehouseManager", adVarChar, adParamInput, 500, cmbWarehouseManager.text)
        ...
        If TransferStockId = 0 Then
            cmd.CommandText = "INV_TransferStock_Insert"
        Else
            'cmd.Parameters.Append cmd.CreateParameter("@isReopen", adBoolean, adParamInput, , isReopen)
            cmd.CommandText = "INV_TransferStock_Update"
        End If
        
        cmd.Execute
        TransferStockId = cmd.Parameters("@TransferStockId")
        ...
        For Each item In lvItems.ListItems
            ...
            cmd.Parameters.Append cmd.CreateParameter("@TransferStockLineId", adInteger, adParamInputOutput, , Val(item.text))
            cmd.Parameters.Append cmd.CreateParameter("@TransferStockId", adInteger, adParamInput, , TransferStockId)
            ...
            cmd.Parameters.Append cmd.CreateParameter("@isConvert", adBoolean, adParamInput, , isConvert)
            If item.text = "" Then
                cmd.CommandText = "INV_TransferStockLine_Insert"
            Else
                ...
                cmd.Parameters.Append cmd.CreateParameter("@isReopen", adBoolean, adParamInput, , isReopen)
                cmd.CommandText = "INV_TransferStockLine_Update"
            End If
            cmd.Execute
            item.text = cmd.Parameters("@TransferStockLineId")
        Next
'
        ...
        For ctr = 0 To ctrOrderLine
            ...
            If OrderLine(ctr) <> 0 Then
                cmd.Parameters.Append cmd.CreateParameter("@TransferStockLineId", adInteger, adParamInput, , OrderLine(ctr))
                cmd.CommandText = "INV_TransferStockLine_Delete"
                cmd.Execute
            Else
                Exit For
            End If
...
'
        ...
        For Each item In lvSearch.ListItems
            If TransferStockId = item.text Then
        ...
        If isFound = False Then
            Set item = lvSearch.ListItems.add(, , TransferStockId)
                item.SubItems(1) = txtOrderNumber.text
                item.SubItems(2) = txtStatus.text
                item.Selected = True
                item.EnsureVisible
...
'            Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\INV_TransferStock.rpt")
'            crxRpt.RecordSelectionFormula = "{INV_TransferStock.TransferStockId}= " & TransferStockId & ""
...
Public Sub Populate(ByVal data As String)
    Select Case data
        ...
        Case "WarehouseManager"
            ...
            cmd.Parameters.Append cmd.CreateParameter("@WarehouseManagerId", adInteger, adParamInput, , Null)
            Set rec = cmd.Execute
            cmbWarehouseManager.Clear
            If Not rec.EOF Then
                Do Until rec.EOF
                    If rec!isActive = "True" Then
                        cmbWarehouseManager.AddItem rec!Name
                        cmbWarehouseManager.ItemData(cmbWarehouseManager.NewIndex) = rec!WarehouseManagerId
                    End If
                    rec.MoveNext
                Loop
            End If
            con.Close
            On Error Resume Next
            cmbWarehouseManager.ListIndex = 0
        Case "TransferStockGet"
            Set con = New ADODB.Connection
            Set cmd = New ADODB.Command
            Set rec = New ADODB.Recordset
            con.ConnectionString = ConnString
            ...
            cmd.ActiveConnection = con
            cmd.CommandType = adCmdStoredProc
            cmd.CommandText = "INV_TransferStock_Get"
            cmd.Parameters.Append cmd.CreateParameter("@TransferStockId", adInteger, adParamInput, , TransferStockId)
            Set rec = cmd.Execute
            If Not rec.EOF Then
                'If rec!isCashAdvance = "False" Then
                    WarehouseManagerId = rec!WarehouseManagerId
...
'                    End If
        ...
        Case "SalesOrderLoad"
            ...
            If Not rec.EOF Then
                Do Until rec.EOF
                    If rec!isCashAdvance = "False" Then
                        Set item = lvSearch.ListItems.add(, , rec!TransferStockId)
        ...
        Case "TransferStockLineGet"
            ...
            cmd.ActiveConnection = con
            cmd.CommandType = adCmdStoredProc
            cmd.CommandText = "INV_TransferStockLine_Get"
            cmd.Parameters.Append cmd.CreateParameter("@TransferStockId", adInteger, adParamInput, , TransferStockId)
            Set rec = cmd.Execute
            lvItems.ListItems.Clear
            If Not rec.EOF Then
                Do Until rec.EOF
                    Set item = lvItems.ListItems.add(, , rec!TransferStockLineId)
                        item.SubItems(1) = rec!TransferStockId
...
Private Sub btnSearch_Click()
    ...
    cmd.CommandType = adCmdStoredProc
    cmd.CommandText = "INV_TransferStock_Get"
    cmd.Parameters.Append cmd.CreateParameter("@TransferStockId", adInteger, adParamInput, , Null)
...
Private Sub btnStatus_Click()
    If StatusId = 1 Then
        ...
        If Me.StatusId = 2 Then
            btnStatus.Caption = "Reopen Order"
            'btnStatus.Caption = "Order Completed"
...
Private Sub cmbCustomer_Change()
    If Trim(cmbCustomer.text) <> "" Then
        ...
        If Not rec.EOF Then
            ...
            Do Until rec.EOF
                If rec!isActive = "True" Then
                    Set item = lvCustomer.ListItems.add(, , rec!WarehouseManagerId)
...
Private Sub lvItemList_DblClick()
    ...
    If lvItemList.ListItems.Count > 0 Then
        ...
        INV_TransferStockOptFrm.lblAvailable.Caption = lvItemList.SelectedItem.SubItems(6)
        INV_TransferStockOptFrm.Show (1)
