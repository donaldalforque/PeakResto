...
Begin VB.Form RPT_INV_InventoryProductPricingFrm 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   0
      Width           =   3855
      Begin VB.CheckBox chkShowOtherPrice 
         BackColor       =   &H00E0E0E0&
         Caption         =   "Include other price setup"
         BeginProperty Font 
            Name            =   "Calibri"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_INV_InventoryProductPricing.frx":002F
         Left            =   1320
         List            =   "RPT_INV_InventoryProductPricing.frx":003F
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   2880
         Width           =   2415
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\InventoryProductPricing.rpt")
    ...
    Else
        crxRpt.ParameterFields.GetItemByName("IncludePrices").AddCurrentValue "YES"
    End If
