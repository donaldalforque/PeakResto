...
Begin VB.Form RPT_POS_SalesByCashierFrm 
   Caption         =   "POS Sales by Cashier"
   ClientHeight    =   9015
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15090
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_POS_SalesByCashierFrm.frx":0000
         Left            =   1320
         List            =   "RPT_POS_SalesByCashierFrm.frx":0013
      ...
      Begin VB.ComboBox cmbCashier 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_POS_SalesByCashierFrm.frx":0030
         Left            =   1320
         List            =   "RPT_POS_SalesByCashierFrm.frx":0032
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   720
         Width           =   2415
   ...
   End
End
Attribute VB_Name = "RPT_POS_SalesByCashierFrm"
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\POS_SalesByCashierSummary.rpt")
