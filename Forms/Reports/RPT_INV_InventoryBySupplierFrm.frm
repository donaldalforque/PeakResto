...
Begin VB.Form RPT_INV_InventoryBySupplierFrm 
   Caption         =   "Inventory by Supplier"
   ClientHeight    =   8985
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15060
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbProduct 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_INV_InventoryBySupplierFrm.frx":0000
         Left            =   1320
         List            =   "RPT_INV_InventoryBySupplierFrm.frx":000A
         Style           =   2  'Dropdown List
         TabIndex        =   7
         Top             =   4800
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_INV_InventoryBySupplierFrm.frx":002F
         Left            =   1320
         List            =   "RPT_INV_InventoryBySupplierFrm.frx":0042
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   3120
         Width           =   2415
   ...
   End
End
Attribute VB_Name = "RPT_INV_InventoryBySupplierFrm"
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\InventoryByVendor.rpt")
