...
Private Sub btnGenerate_Click()
    ...
    sql = "SELECT PO_PurchaseOrder.OrderNumber,PO_PurchaseOrder.TruckNumber,PO_PurchaseOrder.ScaleNumber," & _
          ...
          "GLOBAL_DocStatus.Status FROM Peak_Resto.dbo.PO_PurchaseOrder PO_PurchaseOrder INNER JOIN " & _
          "Peak_Resto.dbo.GLOBAL_DocStatus GLOBAL_DocStatus ON PO_PurchaseOrder.StatusId = GLOBAL_DocStatus.StatusId " & _
          "INNER JOIN Peak_Resto.dbo.BASE_Customer BASE_Customer ON PO_PurchaseOrder.CustomerId = BASE_Customer.CustomerId " & _
          "INNER JOIN Peak_Resto.dbo.PO_PurchaseOrder_Line PO_PurchaseOrder_Line ON PO_PurchaseOrder.PurchaseOrderId = " & _
          "PO_PurchaseOrder_Line.PurchaseOrderId INNER JOIN Peak_Resto.dbo.BASE_Product BASE_Product ON PO_PurchaseOrder_Line." & _
