...
Begin VB.Form RPT_SO_CustomerListFrm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbSort 
         ...
         Left            =   1320
         List            =   "RPT_SO_CustomerListFrm.frx":003F
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\CustomerList.rpt")
    ...
    Select Case cmbSort.ListIndex
        ...
        Case 2
            OrderBy = "ORDER BY BASE_Customer.Name ASC"
        Case 3
            OrderBy = "ORDER BY BASE_Customer.Address"
    End Select
    
    sql = "SELECT * FROM BASE_Customer WHERE BASE_Customer.isActive = 'True'" & Customer & OrderBy
