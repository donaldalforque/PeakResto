...
Begin VB.Form RPT_SO_SalesByProductDetailsFrm 
   Caption         =   "Sales by Product Details"
   ClientHeight    =   9015
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15090
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbCustomer 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_SalesByProductDetailsFrm.frx":0000
         Left            =   1320
         List            =   "RPT_SO_SalesByProductDetailsFrm.frx":000A
      ...
      Begin VB.ComboBox cmbStatus 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_SalesByProductDetailsFrm.frx":002F
         Left            =   1320
         List            =   "RPT_SO_SalesByProductDetailsFrm.frx":0039
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   960
         Width           =   2415
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_SalesByProductDetailsFrm.frx":005E
         Left            =   1320
         List            =   "RPT_SO_SalesByProductDetailsFrm.frx":0074
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   3480
         Width           =   2415
      ...
      Begin VB.ComboBox cmbProduct 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_SalesByProductDetailsFrm.frx":00B3
         Left            =   1320
         List            =   "RPT_SO_SalesByProductDetailsFrm.frx":00BD
         Style           =   2  'Dropdown List
         TabIndex        =   1
         Top             =   600
         Width           =   2415
   ...
   End
End
Attribute VB_Name = "RPT_SO_SalesByProductDetailsFrm"
...
Private Sub btnGenerate_Click()
    ...
    Screen.MousePointer = vbHourglass
        ...
        Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\SOSalesDetails.rpt")
