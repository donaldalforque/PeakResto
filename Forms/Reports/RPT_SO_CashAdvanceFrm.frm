...
Begin VB.Form RPT_SO_CashAdvanceFrm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbCustomer 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_CashAdvanceFrm.frx":0000
         Left            =   1320
         List            =   "RPT_SO_CashAdvanceFrm.frx":000A
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_CashAdvanceFrm.frx":002F
         Left            =   1320
         List            =   "RPT_SO_CashAdvanceFrm.frx":003F
         Style           =   2  'Dropdown List
         TabIndex        =   1
         Top             =   1800
         Width           =   2415
   ...
   End
End
Attribute VB_Name = "RPT_SO_CashAdvanceFrm"
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\cashadvance.rpt")
    ...
    sql = "SELECT SO_SalesOrder.Total,SO_SalesOrder.Balance,BASE_Customer.CustomerId,BASE_Customer.Name " & _
          "FROM Peak_Resto.dbo.SO_SalesOrder SO_SalesOrder INNER JOIN Peak_Resto.dbo.BASE_Customer BASE_Customer ON " & _
          "SO_SalesOrder.CustomerId = BASE_Customer.CustomerId INNER JOIN GLOBAL_DocStatus ON SO_SalesOrder.StatusId = GLOBAL_DocStatus.StatusId " & _
          "WHERE SO_SalesOrder.isCashAdvance = 'True' AND GLOBAL_DocStatus.StatusId = 2 AND SO_SalesOrder.Balance > 0 " & Customer & OrderBy
