...
Begin VB.Form RPT_POS_SalesByInvoiceFrm 
   Caption         =   "POS Sales by Invoice"
   ClientHeight    =   9015
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15090
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SalesByInvoiceFrm.frx":0000
         Left            =   1320
         List            =   "RPT_SalesByInvoiceFrm.frx":001B
      ...
      Begin VB.ComboBox cmbCashier 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SalesByInvoiceFrm.frx":004D
         Left            =   1320
         List            =   "RPT_SalesByInvoiceFrm.frx":004F
         Style           =   2  'Dropdown List
         TabIndex        =   7
         Top             =   6600
         Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "RPT_POS_SalesByInvoiceFrm"
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\POS_SalesByInvoice.rpt")
    ...
    crxRpt.ParameterFields.GetItemByName("@Invoice").AddCurrentValue txtOR.text
