...
Begin VB.Form RPT_INV_NewStockSummaryFrm 
   Caption         =   "New Stock Summary"
   ClientHeight    =   9015
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   15090
   ...
   End
End
Attribute VB_Name = "RPT_INV_NewStockSummaryFrm"
...
Private Sub btnGenerate_Click()
    ...
    If chkGroup.value = Checked Then crxRpt.ParameterFields.GetItemByName("@Name").AddCurrentValue txtProduct.Text
