...
Begin VB.Form RPT_SalesByIngredientDetailsFrm 
   Caption         =   "Sales by Ingredient Details"
   ClientHeight    =   9015
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   15090
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbProduct 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SalesByIngredientDetailsFrm.frx":0000
         Left            =   1320
         List            =   "RPT_SalesByIngredientDetailsFrm.frx":0002
         TabIndex        =   1
         Top             =   720
         Width           =   2415
      End
   ...
   End
End
Attribute VB_Name = "RPT_SalesByIngredientDetailsFrm"
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\InventoryByIngredientsSold.rpt")
