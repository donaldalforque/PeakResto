...
Begin VB.Form RPT_SalesByIngredientSummaryFrm 
   Caption         =   "Sales by Ingredient Summary"
   ClientHeight    =   9015
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   15090
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbProduct 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SalesByIngredientSummaryFrm.frx":0000
         Left            =   1320
         List            =   "RPT_SalesByIngredientSummaryFrm.frx":0002
         TabIndex        =   4
         Top             =   720
         Width           =   2415
      End
   ...
   End
End
Attribute VB_Name = "RPT_SalesByIngredientSummaryFrm"
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\RPT_INV_InventoryByIngredientsSoldSummary.rpt")
