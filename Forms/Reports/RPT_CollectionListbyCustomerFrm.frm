...
'    End If
    ...
    Select Case cmbCustomer.ListIndex
        ...
        Case 0
            Customer = ""
        Case Else
            Customer = "BASE_Customer.CustomerId = '" & cmbCustomer.ItemData(cmbCustomer.ListIndex) & "' "
    End Select
...
'    If chkAgingAccounts.value = 0 Then
        sql = " SELECT SO_SalesOrder.Balance,BASE_Customer.CustomerId,BASE_Customer.CustomerCode,BASE_Customer.Name " & _
              "From Peak_Resto.dbo.SO_SalesOrder SO_SalesOrder INNER JOIN Peak_Resto.dbo.BASE_Customer BASE_Customer ON SO_SalesOrder.CustomerId = BASE_Customer.CustomerId " & _
              "WHERE SO_SalesOrder.Balance > 0 and SO_SalesOrder.statusid = 2 " & Customer & Code & Collector & OrderBy
